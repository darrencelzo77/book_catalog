    ...
    <div class="container">
        ...
        <div class="row g-4">
                ...
                <div class="book-card">
                    ...
                    <div class="book-content">
                        ...
                        <div class="book-footer">
                            ...
                            <button class="book-link" data-bs-toggle="modal" data-bs-target="#bookModal1">Learn More</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="book-card">
                    ...
                    <div class="book-content">
                        ...
                        <div class="book-footer">
                            ...
                            <button class="book-link" data-bs-toggle="modal" data-bs-target="#bookModal2">Learn More</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="book-card">
                    ...
                    <div class="book-content">
                        ...
                        <div class="book-footer">
                            ...
                            <button class="book-link" data-bs-toggle="modal" data-bs-target="#bookModal3">Learn More</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 animate__animated animate__fadeInUp animate__delay-3s">
                <div class="book-card">
                    <div class="book-image-container">
                        <div class="book-badge">Science</div>
                    ...
                    <div class="book-content">
                        ...
                        <div class="book-footer">
                            ...
                            <button class="book-link" data-bs-toggle="modal" data-bs-target="#bookModal4">Learn More</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center mt-5 animate__animated animate__fadeIn animate__delay-4s">
            <a href="pages/book-catalog.html" class="btn btn-outline-primary">View Full Catalog</a>
        </div>
    </div>
</section>
...
<section class="testimonials-section py-5">
    <div class="container">
        <div class="text-center mb-5">
            ...
            <div class="rating-summary animate__animated animate__fadeIn animate__delay-1s">
                <div class="rating-number">4.9</div>
                <div class="rating-stars">★★★★★</div>
                <div class="rating-count">Based on 800+ reviews</div>
            </div>
        </div>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="testimonial-card text-center">
                        <div class="author-img-container">
                            <img src="https://randomuser.me/api/portraits/men/32.jpg" alt="David Peterson" class="author-img">
                        </div>
                        <div class="testimonial-content">
                            <div class="testimonial-text">
                                "The editorial team transformed my manuscript into a polished masterpiece. Their attention to detail and marketing strategies helped my book reach audiences I never imagined."
                            </div>
                            <div class="rating-stars mb-3">★★★★★</div>
                            <div class="author-info">
                                <h4 class="author-name">David Peterson</h4>
                                <p class="author-title">Fiction Writer</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="testimonial-card text-center">
                        ...
                        <div class="testimonial-content">
                            <div class="testimonial-text">
                                "From cover design to distribution, every step was handled professionally. My book sales tripled within the first month thanks to their marketing expertise."
                            </div>
                            <div class="rating-stars mb-3">★★★★★</div>
                            <div class="author-info">
                                <h4 class="author-name">Sarah Johnson</h4>
                                <p class="author-title">Non-fiction Author</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="testimonial-card text-center">
                        <div class="author-img-container">
                            <img src="https://randomuser.me/api/portraits/men/75.jpg" alt="Michael Chen" class="author-img">
                        </div>
                        <div class="testimonial-content">
                            <div class="testimonial-text">
                                "The publishing process was seamless and stress-free. Their team's guidance helped me navigate the complex world of book publishing as a first-time author."
                            </div>
                            <div class="rating-stars mb-3">★★★★★</div>
                            <div class="author-info">
                                <h4 class="author-name">Michael Chen</h4>
                                <p class="author-title">Business Author</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="testimonial-card text-center">
                        ...
                        <div class="testimonial-content">
                            <div class="testimonial-text">
                                "I'm amazed by the quality of their editing services. They preserved my voice while making my manuscript shine. The book trailer they created went viral!"
                            </div>
                            <div class="rating-stars mb-3">★★★★★</div>
                            <div class="author-info">
                                <h4 class="author-name">Emily Rodriguez</h4>
                                <p class="author-title">Young Adult Author</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="testimonial-card text-center">
                        <div class="author-img-container">
                            <img src="https://randomuser.me/api/portraits/men/81.jpg" alt="James Wilson" class="author-img">
                        </div>
                        <div class="testimonial-content">
                            <div class="testimonial-text">
                                "The global distribution network is incredible. My book is now available in 12 countries and has been translated into 3 languages thanks to this team."
                            </div>
                            <div class="rating-stars mb-3">★★★★★</div>
                            <div class="author-info">
                                <h4 class="author-name">James Wilson</h4>
                                <p class="author-title">Science Fiction Writer</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="container my-5">
    <h2 class="text-center mb-4"> <b>Meet Our Featured Authors</h2></b>
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="author-image-container" style="background-image: url('images/prof2.jpg');"></div>
                <div class="card-body">
                    <h3 class="card-title">Dr. Sarah Chen</h3>
                    <p class="card-text">Award-winning author of 12 science fiction novels, exploring the intersection of technology </p>
                    <div class="mb-3">
                        <span class="badge bg-light text-dark me-2">12 Books</span>
                        <span class="badge bg-primary text-white">Hugo Award Winner</span>
                    </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="author-image-container" style="background-image: url('images/prof1.jpg');"></div>
                <div class="card-body">
                    <h3 class="card-title">Marcus Rivera</h3>
                    <p class="card-text">Bestselling historical fiction writer known for bringing ancient civilizations to life </p>
                    <div class="mb-3">
                        <span class="badge bg-light text-dark me-2">8 Books</span>
                        <span class="badge bg-primary text-white">National Book Award Finalist</span>
                    </div>
                    <a href="#" class="btn btn-outline-primary">View Profile</a>
                </div>
            </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="author-image-container" style="background-image: url('images/prof3.jpg');"></div>
                <div class="card-body">
                    <h3 class="card-title">Emily Watson</h3>
                    <p class="card-text">Life coach and wellness expert helping millions transform their lives through practical and achievable</p>
                    <div class="mb-3">
                        <span class="badge bg-light text-dark me-2">6 Books</span>
                        <span class="badge bg-primary text-white">NY Times Bestseller</span>
                    </div>
                    <a href="#" class="btn btn-outline-primary">View Profile</a>
                </div>
            </div>
    ...
    <div class="text-center mt-4">
        <a href="#" class="btn btn-primary">View All Authors</a>
    </div>
</div>
